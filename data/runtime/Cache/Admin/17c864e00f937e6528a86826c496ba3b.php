...
<html>
	<head>
		...
		<link href="/ThinkCMF/admin/themes/simplebootx/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a href="/ThinkCMF">ThinkCMF <?php echo L('ADMIN_CENTER');?></a></h1>
...
var GV = {
	DIMAUB: "",
	JS_ROOT: "/ThinkCMF/public/js/",//js版本号
	TOKEN : ''	//token ajax全局
};
</script>
<script src="/ThinkCMF/public/js/wind.js"></script>
<script src="/ThinkCMF/public/js/jquery.js"></script>
<script type="text/javascript" src="/ThinkCMF/public/js/common.js"></script>
<script>
;(function(){
