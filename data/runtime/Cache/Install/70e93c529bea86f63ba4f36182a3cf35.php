...
<body>
	...
	<div class="version"><?php echo (SIMPLEWIND_CMF_VERSION); ?></div>
		...
		<section class="section">
			...
			<form id="js-install-form" action="/ThinkCMF/index.php?g=install&a=step4" method="post">
				...
				<div class="bottom text-center">
					<a href="/ThinkCMF/index.php?g=install&a=step2" class="btn btn-primary">上一步</a>
					<button type="submit" class="btn btn-primary">创建数据</button>
				</div>
			</form>
		</section>
		<script src="/ThinkCMF/public/js/jquery.js"></script>
		<script src="/ThinkCMF/public/js/validate.js"></script>
		<script src="/ThinkCMF/public/js/ajaxForm.js"></script>
		<script>
			function TestDbPwd() {
				...
				var url = "/ThinkCMF/index.php?g=install&a=testdbpwd";
				$.ajax({
					type : "POST",
					url : url,
					data : data,
